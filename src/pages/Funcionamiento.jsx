...
export const Funcionamiento = () => {
  return (
    <div>
    <h1 class="mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Buscamoser ser la aplicacion <span class="text-blue-600 dark:text-blue-500">#1</span> en experiencia de usuario.</h1>
